...
public class CustomDialogActivity extends AppCompatActivity {
    ...
    private View.OnClickListener listener_call_calender_dialog = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            CustomDialog customDialog = new CustomDialog(activity, CustomDialog.DialogMode.MODE_CANLENDER);
            customDialog.setTitle("캘린더 다이얼 로그");
            customDialog.setCalenderDialogClickListener(new CustomDialog.OnCalenderDialogClickListener() {
                @Override

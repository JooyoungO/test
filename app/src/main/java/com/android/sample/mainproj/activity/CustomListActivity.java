...
public class CustomListActivity extends AppCompatActivity {
    ...
    */
    ...
    private void init() {
        ...
        customAdapter = new CustomAdapter(this, memberList);
        ...
        baseAdapter = new BaseAdapter() {
            ...
            @Override
            public long getItemId(int posisiton) {

                return posisiton;
            }

            @Override
            public View getView(int position, View view, ViewGroup parent) { //Holder 개념

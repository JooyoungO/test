...
public class CustomToastActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btn_custom_toast_red;

    private Button btn_custom_toast_green;

    private Button btn_custom_toast_blue;
    ...
    private void setting() {
        ...
        editXChangedListener = new TextChangedListener(et_toast_x_pos, listener_toast_pos_changed);

        editYChangedListener = new TextChangedListener(et_toast_y_pos, listener_toast_pos_changed);

        sp_toast_gravity.setSelection(1);
    ...
    private void addListener() {
        ...
        ibtn_back_click.setOnClickListener(listener_back_cick);
    ...
    private View.OnClickListener listener_back_cick = new View.OnClickListener() {
        @Override
    ...
    private View.OnClickListener listener_show_custom_toast = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            LinearLayout layout = (LinearLayout) getLayoutInflater().inflate(R.layout.layout_custom_toast, null);
    ...
    private TextChangedListener.OnTextChangedListener listener_toast_pos_changed = new TextChangedListener.OnTextChangedListener() {
        @Override
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btn_custom_toast_red) {
            ...
            CustomToast.makeToast(activity, "hello message").setTextColor(Color.RED).show();
        }
        else if(v.getId() == R.id.btn_custom_toast_green) {

            CustomToast.makeToast(activity, "hello message").setTextColor(Color.GREEN).show();
        }
        else if(v.getId() == R.id.btn_custom_toast_blue) {

            CustomToast.makeToast(activity, "hello message").setTextColor(Color.BLUE).show();
        }
    }
}
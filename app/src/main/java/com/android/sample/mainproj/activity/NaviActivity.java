...
public class NaviActivity extends AppCompatActivity {
    ...
    NavigationView.OnNavigationItemSelectedListener listener_navi_click = new NavigationView.OnNavigationItemSelectedListener() {
        @Override
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {

            if (item.getItemId() == R.id.icon_post) {

                //Toast.makeText(activity, "Post Menu Clicked!", Toast.LENGTH_SHORT).show();

                changeFragmentView(postFragment);
            }
            else if (item.getItemId() == R.id.icon_home) {

                //Toast.makeText(activity, "Home Menu Clicked!", Toast.LENGTH_SHORT).show();
    ...
    private void changeFragmentView(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.layout_navi_fragment, fragment);

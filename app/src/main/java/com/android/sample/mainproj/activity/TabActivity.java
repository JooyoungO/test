...
public class TabActivity extends AppCompatActivity
{
    ...
    private void setting()
    {
        ...
        tabLayoutMediator = new TabLayoutMediator(tl_main, vp_main, listener_connect_tab);
    ...
    private TabLayoutMediator.TabConfigurationStrategy listener_connect_tab = new TabLayoutMediator.TabConfigurationStrategy()
    {
        @Override

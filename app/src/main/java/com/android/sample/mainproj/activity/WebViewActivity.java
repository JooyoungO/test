...
public class WebViewActivity extends AppCompatActivity {
    ...
    private ImageButton ibtn_back_click, ibtn_forward_click;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            wv_main.loadUrl("http://192.168.160.1:8082/WebView");
    ...
    private final View.OnClickListener listener_forward_click = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private final View.OnClickListener listener_url_move = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
    ...
    private void initWebViewSetting() {
        ...
        //해당 속성이 true일 경우 팝업창 등을 호출시 팝업 호출 가능
        //단 setWebChromeClient를 통해 팝업창을 구현해 주어야 한다.
        wv_main.getSettings().setSupportMultipleWindows(true);

        //해당 속성이 false일 경우 자동으로 window.open 함수가 호출되는 것을 방지
        //단 setWebChromeClient를 통해 팝업창을 구현해 주어야 한다.
        wv_main.getSettings().setJavaScriptCanOpenWindowsAutomatically(false);

        wv_main.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    LogService.info(activity, "X : " + posX + " Y : " + posY);
                }
    ...
    private class JavaScriptClient extends WebChromeClient {
        ...
        public void sendData(final String data) {
            ...
            try {
                LogService.info(activity, "data : " + data);
                ...
                if(type.equals("toast")) {
                    ...
                    String urlSchema = schema + "://" + host + "?id=12" + "&message=" + msg;
    ...
    private WebViewClient listener_web_load = new WebViewClient() {
        ...
        //url 이나 상태에 따라서 url 흐름을 조작하거나 web에 script를 호출하는 부분을 앱에서 받아 줄 때 사용
        @Override
